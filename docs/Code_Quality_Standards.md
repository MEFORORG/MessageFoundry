...
Ordered by anti-slop leverage, not effort (build placement per §5). All five are **shipped** — items 1–4 advisory (\#1028 / \#1040), item 5 enforced by the required `ruff check` leg (\#1047):
