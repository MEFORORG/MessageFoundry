...
> **What this pass is, and what it replaces.** Every one of the **103 open items** is re-scored here
...
Value: **1**:3 · **2**:10 · **3**:19 · **4**:14 · **5**:19 · **6**:28 · **7**:7 · **8**:2 · **9**:1. Difficulty: **1**:5 · **2**:22 · **3**:37 · **4**:20 · **5**:5 · **6**:9 · **7**:2 · **8**:2 · **9**:1.
Tiers: **P1** 9 · **P2** 24 · **P3** 17 · **DEMAND-GATE** 53.
Quadrants: _quick win_ 33 · _big bet_ 5 · _fill-in_ 56 · _money pit_ 9.

*All four lines sum to 103, the open-item count. They are recomputed with the table,
