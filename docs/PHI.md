...
- [ ] **Create the first administrator with `messagefoundry admin-create`** (see [SECURITY.md](SECURITY.md)) — a fresh store has no account until you make one.
