...
to cut one and what goes in it. Re-cutting a batch -- dropping a red item -- goes back to that
Manager, or to a Manager you spawn if it is gone; you do not edit a batch's contents yourself.
