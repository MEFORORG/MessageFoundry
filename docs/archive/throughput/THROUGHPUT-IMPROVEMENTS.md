...
throughput research (`marketing/throughput-research-2026-06-13.md`, local — see
[SECURITY-DOCS-POLICY.md](../../SECURITY-DOCS-POLICY.md)) and
...
- **Durable-write** — *behind*, and both halves of the original line were stale. The "~7 commits/msg" was
  **modelled, never measured**: P0 (2026-07-13) put a counter on it and recorded **10.47 committed txn/msg** at the
  `H=D=dests=1` mechanism shape and **29.20** at `H=8` — ~40% above the model
  ([`THROUGHPUT-STATUS-2026-07-10.md`](../../benchmarks/THROUGHPUT-STATUS-2026-07-10.md)). *(A larger `txn`
