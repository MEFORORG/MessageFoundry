...
> Proving it is tracked as [**BACKLOG #319**](BACKLOG.md#319-ag-rig-validation-prove-the-multi-subnet-failover-reconnect).
>
...
> regardless. If you are reading this well after the date above, check #319 before assuming the
