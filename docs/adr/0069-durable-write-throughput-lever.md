...
- `docs/archive/throughput/throughput-roadmap.md` (B8 store ceiling; the serial round-trip diagnosis: ~2.84 ms/round-trip vs ~170 µs fsync) and `docs/archive/throughput/throughput-build-plan.md` (B1–B3 chain-cut DONE; engine per-message CPU as the current wall; B5/B6).
