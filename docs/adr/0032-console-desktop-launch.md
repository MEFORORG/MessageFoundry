...
- **Status:** **Accepted (2026-06-20) — built.** Phase A (the windowed entry point + the shortcut
  installer) is built. Phase B (a frozen, zero-Python installer) was **ratified Accepted (2026-06-28)**
  and built on the installer lane — see the *Amendment (2026-06-28) — Phase B* section below, its
  *Ratification decisions*, and [BACKLOG #39](../BACKLOG.md). (Phase B's packaging assets live under
  `packaging/console-installer/`; the build leg is the `release-console-installer` job in
  `.github/workflows/release.yml`, `needs: release`.)
