...
**Status:** **Accepted — implemented.** `claim_mode = pooled` is the shipped **default** (flipped 2026-07-04 via **PR #765**; tracking issue #744; gate armed 2026-07-03); `per_lane` is retained as the **byte-identical opt-out** (`[pipeline].claim_mode = "per_lane"`, still enforced by the zero-pooled-construction sentinel). · **Date:** 2026-07-02 (default flipped 2026-07-04, PR #765 / issue #744)
