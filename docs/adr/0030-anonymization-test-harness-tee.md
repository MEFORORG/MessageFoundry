...
2. **Fold in the drifted copy.** `tests/test_load_config.py`'s `_FORBIDDEN_SUBSTRINGS` (adds *olympus,
   experian, omnicell, ambra, telcor, intelepacs, interconnect, cynchealth, readyset, clarity*) **and** its
