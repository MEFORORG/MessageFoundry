...
INVENTORY: dict[str, frozenset[str]] = {
    ...
    # arm of the subject-exists screen's own control. Unpredictability is not the property being
    # bought -- absence is. It draws from the CSPRNG because a 128-bit tail is the cheapest way to be
    # sure the name was never committed, and because generating it is what keeps it out of the file
