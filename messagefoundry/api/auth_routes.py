...
def add_auth_routes(app: FastAPI) -> AdminHandlers:
    ...
    async def negotiate(
        ...
        # stamp alone. The client now meets 403 + X-Step-Up-Required on its first such action and
        # answers it with POST /me/reauth (a live directory re-bind) or an engine factor.
