...
claim and the only thing this file reads. It said fourteen until the review gate was retired on
2026-09-05 and is thirteen now, and reconciliation is exactly how a context arrives here unproven: the
...
# The review-gate controls that stood here were removed on 2026-09-05 with review-gate.yml,
# its `reviewed` label and the Reviewer seat. They were the only consumers of the
# absence detector, which went with them. Nothing now requires that a pull request be read
# before it merges; what blocks a merge is the required check set. See docs/CI.md.
