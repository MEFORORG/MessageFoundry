...
# The operator-local lookup (BACKLOG #1835) is exercised in tests/test_profile_lookup.py, which
# covers the [connscale] and [estate] schemas through the same shared body (BACKLOG #1837). One home
# for it, so a regression cannot pass there and fail here or the reverse.
