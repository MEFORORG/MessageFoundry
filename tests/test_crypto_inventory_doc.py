...
_RETIRED_CLAIMS = (
    ...
    # The false audit-chain default: `serve` refuses to start with no store key, so the shipped chain
    # is keyed HMAC, and keyless SHA-256 needs the audited opt-out (BACKLOG #282).
