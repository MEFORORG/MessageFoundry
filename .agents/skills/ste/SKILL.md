...
Run `pwsh -NoProfile -File scripts/codex/invoke.ps1 source-skill ste` from the repo root, then read the returned file before doing this task. That file is authoritative; do not copy its procedure here.
